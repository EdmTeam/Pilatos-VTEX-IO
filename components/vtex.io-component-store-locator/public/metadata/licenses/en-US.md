...
Without prejudice of the provisions of these Terms, User shall comply with all other agreements, terms and conditions regulating their relationship with VTEX, including, without limitation, the Master Services Agreement (as defined hereinbelow) available on [https://blacksip.com/](https://blacksip.com/) and the Term of Use of the APP they intend to access, use or install.
